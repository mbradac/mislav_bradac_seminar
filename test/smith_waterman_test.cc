...
int main() {
  const char query_path[] = "test_data/query/P19930.fasta";
  const char database_path[] = "test_data/database/uniprot_sprot196.fasta";
  const char matrix_path[] = "test_data/matrix/blosum50.mat";
  const char results_path[] = "test_data/results/P19930_sprot196_blosum50_r1q3";
  int r = 1;
  int q = 3;
  ...
  std::vector<short> results =
      SmithWaterman(query_vector[0], database, matrix, q, r);
